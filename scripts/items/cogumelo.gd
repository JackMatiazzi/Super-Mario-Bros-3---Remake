...
func ser_coletado(jogador: JogadorSMB3) -> void:
	...
	# Se o jogador for pequeno, ele cresce para Super Mario
	if jogador.estado_atual == JogadorSMB3.EstadoPoder.PEQUENO:
		jogador.estado_atual = JogadorSMB3.EstadoPoder.SUPER
		jogador._atualizar_visual_personagem()
		jogador._ajustar_caixa_colisao()
		# Aqui você pode instanciar o som de power-up ou congelar o jogo por frames se quiser
...
#class_name Cogumelo extends CharacterBody2D
#
#const SPEED = 45.0
#
#var direction := 1.0
